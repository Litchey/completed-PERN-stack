...
try {
    ...
    const { name, email, password, storetype, productlist, storeimg, productimg } = req.body;
    ...
    // 4. Enter the user inside the database
     ...
     const newUser = await pool.query(
        "INSERT INTO users (user_name, user_email, user_password, user_storetype, user_productlist, user_storeimg, user_productimg) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *", 
        [name, email, bcryptPassword, storetype, productlist, storeimg, productimg]
    );
